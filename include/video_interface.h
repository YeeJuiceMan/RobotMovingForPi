...
struct rgb_t
{
    uint8_t r;  // pixel component red
    uint8_t g;  // pixel component green
    uint8_t b;  // pixel component blue
};

struct image_row_t
{
    struct rgb_t column[IMAGE_WIDTH];     // the pixels for a particular row of the image
};
